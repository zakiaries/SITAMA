    ...
    return Scaffold(
      ...
      body: Column(children: [
        DetailHeader(
          ...
          subtitle: 'Daftar mahasiswa magang Anda',
          showBack: false,
          trailing: IconButton(
              ...
              builder: (context, snap) {
                ...
                return ListView(
                  ...
                  children: [
                    ...
                    if (students.isEmpty)
                      const EmptyState('Belum ada mahasiswa magang',
                          icon: Icons.people_outline,
                          hint: 'Mahasiswa magang bimbingan Anda akan muncul di sini.')
                    else
                      ...students.map((s) {
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Row(children: [
                              Expanded(child: ClipRRect(
                                ...
                                child: LinearProgressIndicator(value: pct, minHeight: 6, backgroundColor: AppColors.borderSubtle, valueColor: const AlwaysStoppedAnimation(AppColors.primary)),
                              )),
