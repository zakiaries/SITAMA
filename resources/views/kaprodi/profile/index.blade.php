...
<div class="stat-grid-4">
  ...
  <div class="stat-mini"><div class="val">{{ $totalDosen }}</div><div class="lbl">Dosen Aktif</div></div>
  <div class="stat-mini"><div class="val">{{ $totalIndustri }}</div><div class="lbl">Industri Mitra</div></div>
  <div class="stat-mini"><div class="val">{{ $totalSeminar }}</div><div class="lbl">Total Seminar</div></div>
</div>
...
<div class="grid-2">
  <div class="card">
    ...
    <div class="info-row"><div class="info-key">Role</div><div class="info-val">
      <span style="background:var(--warn-bg);color:var(--warn-text);font-size:11px;font-weight:600;padding:2px 10px;border-radius:20px;display:inline-flex;align-items:center;gap:5px;"><x-icon name="star" :size="12"/> Superadmin</span>
    </div></div>
  </div>
