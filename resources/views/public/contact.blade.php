  ...
  <div class="grid g2">
    <div>
      <div class="card an" style="margin-bottom:14px;">
        <div class="cinfo" style="margin-bottom:18px;"><div class="ic"><svg width="21" height="21" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="M22 6l-10 7L2 6"/></svg></div><div><div class="lbl">Email</div><div class="val">support@sitama.ac.id</div></div></div>
