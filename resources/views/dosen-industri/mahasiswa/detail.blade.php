...
<div class="lb-card" id="logbook-{{ $lb->id }}">
  <div class="lb-card-head">
    ...
    <div class="lb-body">
      ...
      @if($internship->is_finished)
        {{-- Magang sudah ditutup Kaprodi: komentar jadi jejak akademik yang sah.
             Tombolnya dihilangkan, bukan cuma ditolak server. --}}
        <div style="margin-top:8px;font-size:12px;color:var(--text-muted);display:flex;align-items:center;gap:6px;">
          ...
          Magang sudah selesai — komentar terkunci.
        </div>
      @else
